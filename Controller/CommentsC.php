...
public function InsererComments( $commentContent, $postId ,$id_user) {
    $pdo = openDB();

    try {
        
        $statement = $pdo->prepare("INSERT INTO comments (PostID, content,user_id) VALUES (:PostID, :content, :id_user)");
