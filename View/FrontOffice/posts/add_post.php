...
if(isset($_POST['post-textarea'])) {
    ...
    if(isset($_FILES['photo-upload']) && ($_FILES['photo-upload']['size']!=0)) {
            ...
            if ($file_size > 5000000) {
                ...
                if(in_array($file_ext, $allowed_types)) {
                    ...
                    if(move_uploaded_file($file_tmp, $target_file)) {
                        ...
                        $result = $postsController->InsererPosts($content, $target_file,$user_id);
                        if($result) {
        ...
        $result = $postsController->InsererPosts($content, "",$user_id);
        if($result) {
            header("Location: index.php");
            exit();
        } else {
