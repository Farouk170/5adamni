...
foreach ($entretiens as $entretien) {
    ...
    $event = '<u style="text-decoration:none;">Heure: </u>  ' . $heure . '<br>' . '<u style="text-decoration:none;">Type:</u>  ' . $entretien['type_entretien'] . '<br>' . '<u style="text-decoration:none;">Entreprise:</u>  ' . $entretien['compOffre'] . '<br>' . '<u style="text-decoration:none;">Offre:</u>  ' . $entretien['titreOffre'];
    $events[$date][] = $event;
}
