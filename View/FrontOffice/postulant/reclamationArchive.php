  ...
  <div class="site-wrap">
    ...
    <section class="section-hero overlay inner-page bg-image" style="background-image: url('../images/hero_1.jpg');"
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-7">
            <h1 class="text-white font-weight-bold">Réclamations Archivées</h1>
            <div class="custom-breadcrumbs">
              <a href="index.php" style="text-decoration: none;">Home</a> <span class="mx-2 slash">/</span>
              <span class="text-white"><strong>Réclamations Archivées</strong></span>
            </div>
          </div>
        </div>
      </div>
        ...
        if ($Reclamation['statRec'] === 'Résolue') {
          ...
          if ($reponses) {
            ...
            foreach ($reponses as $reponse) {
              ...
              echo "<div><strong>Date :</strong> {$reponse['dateRep']}</div>";
            ...
            echo "<form action='traitementArchiveSupprimer.php' method='POST' style='display:inline;'>";
            echo "<input type='hidden' name='idRec' value='{$Reclamation['idRec']}'>";
            echo "<input type='hidden' name='archiveRec' value='2'>";
