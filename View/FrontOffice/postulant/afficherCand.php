...
$offrec = new OffreC();
$candidatures = $offrec->listeCandidaturesPostulant($_SESSION['id']);
...
<div class="site-wrap">
          ...
          <nav class="mx-auto site-navigation col-6">
            <ul class="site-menu js-clone-nav d-none d-xl-block ml-0 pl-0">
             <!-- <li><a href=".php" class="nav-link active">offre</a></li>-->
                 <li class=""><a href="index.php" class="nav-link">Offres</a>
    ...
    <section class="section-hero overlay inner-page bg-image" style="background-image: url('../images/hero_1.jpg');" id="home-section">
      <div class="container">
        <div class="row">
          <div class="col-md-7">
            <h1 class="text-white font-weight-bold"> Liste des candidatures</h1>
            <div class="custom-breadcrumbs">
              <a href="index.php" style="text-decoration: none;">Home</a> <span class="mx-2 slash">/</span>
              <span class="text-white"><strong> Liste des candidatures</strong></span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        ...
        <div class="row align-items-center mb-5">
          ...
          <div class="col-lg-4">
            <div class="row">
              <div class="col-6">
                <a href="index.php"  class="btn btn-block btn-light btn-md" style="border: 1px solid #000;"><span class="icon-open_in_new mr-2"></span> voir les offre</a>
              </div>
            </div>
          </div>
        </div>
                              ...
                              <table class="table table-bordered">
                                  ...
                                  <tbody>
                                      ...
                                      <tr>
                                          ...
                                          <td><?php echo $titreOffre['titreOffre']; ?></td> <!-- Affichez le titre de l'offre -->
                                          ...
                                          <?php if (empty($candidature['etatCandidature'])) { ?>
