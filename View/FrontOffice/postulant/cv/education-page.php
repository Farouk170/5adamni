...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../../css/jquery.fancybox.min.css"><link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200" />
            ...
            <ul class="site-menu js-clone-nav d-none d-xl-block ml-0 pl-0">
              ...
              <li class="has-children"><a href="#" class="nav-link active">Compétences</a>
                <ul class="dropdown">
                  ...
                  <li>
                    <a href="experience-page.php" style="display: flex; align-items: center;">
...
<div class="d-flex align-items-center justify-content-between mb-4">
                        <h1 class="mb-0">Gestion des Educations</h1>
                      <button type="button" class="btn btn-primary m-2 btn-lg" onclick="window.location.href='ajout_education.php'" > + Education</button>
                    </div>
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0" style="background-color: white;">
                            <thead>
                                <tr class="text-grey">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><button style="background-color: #7F848C; color: white; border: none;width: 110px;height:40px; border-radius: 4px; font-weight: bold; cursor: pointer;" onclick="openPhotoWindow(<?php echo $rows['id_education']; ?>)" >Aperçu</button></td>
                                    <td>
                                      <button type="button" style="background-color: #2E933C; color: white;width: 80px; height:40px; border: none; border-radius: 4px; font-weight: bold; cursor: pointer;" onclick="window.location.href='modifier_education.php?id_education=<?php echo urlencode($rows['id_education']); ?>&ecole=<?php echo urlencode($rows['ecole']); ?>&date_edu=<?php echo urlencode($rows['date_edu']); ?>&id_type_diplom=<?php echo urlencode($rows['id_diplom']); ?>&diplom=<?php echo urlencode($rows['diplom']); ?>'">Modifier</button>
                                      <button style="background-color: #DC4E4E; color: white;width: 100px;height:40px; border: none; border-radius: 4px; font-weight: bold; cursor: pointer;" onclick="deleteEducation(<?php echo $rows['id_education']; ?>)" type="button">Supprimer</button></td>
                                </tr>
                        ...
                        <div class="pagination text-center d-flex justify-content-center mt-4">
                            <?php
                                if ($currentPage > 1) {
                                    echo '<a class="btn btn-sm btn-primary me-2" href="education-page.php?page=' . ($currentPage - 1) . '">Précédant</a>';
                                }
                                for ($i = 1; $i <= $totalPages; $i++) {
                                    // Add different class for the current page
                                    $activeClass = ($i == $currentPage) ? 'btn-primary active' : 'btn-secondary';
                                    echo '<a class="btn btn-sm ' . $activeClass . ' me-2" href="education-page.php?page=' . $i . '">' . $i . '</a>';
                                }
                                if ($currentPage < $totalPages) {
                                    echo '<a class="btn btn-sm btn-primary" href="education-page.php?page=' . ($currentPage + 1) . '">Suivant</a>';
                                }
                            ?>
                            </div>
                            </div>
