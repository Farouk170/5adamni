...
<div class="site-wrap">
        ...
        <div class="row align-items-center">
          ...
          <nav class="mx-auto site-navigation">
            <ul class="site-menu js-clone-nav d-none d-xl-block ml-0 pl-0">
              <li class="active"><a href="login.php">Offres</a></li>
              <li><a href="login.php">Compétences</a></li>
      ...
      <div class="offer"  style="position: relative;">
        <div class="date-offre"  >
          ...
          <div class="offer-actions">
            <form method="POST" action="guest/detailleOffre.php">
        ...
        <div class="offer-details">
          ...
          <table>
            ...
            <tr> 
            <button style="background-color: #7F848C; color: white; border: none; border-radius: 4px; font-weight: bold; cursor: pointer;" onclick="window.location.href = 'login.php';">Postuler</button>
            </tr>
          </table>
          </div>
        </div>
    ...
    <script>
      ...
      document.getElementById("totalOffres").innerText = "Showing  " + totalOffres + " Jobs";
    ...
    <section class="py-5 bg-image overlay-primary fixed overlay" style="background-image: url('images/hero_1.jpg');">
        <div class="container">
          <div class="row align-items-center">
            <div class="col-md-8">
              <h2 class="text-white">À la recherche d'un emploi?</h2>
              <p class="mb-0 text-white lead">Qu'attendez-vous, devenez l'un des nôtres et trouvez votre destin.</p>
            </div>
            <div class="col-md-3 ml-auto">
              <a href="signup.php" class="btn btn-warning btn-block btn-lg">S'inscrire</a>
            </div>
          </div>
      </div>
    </section>
