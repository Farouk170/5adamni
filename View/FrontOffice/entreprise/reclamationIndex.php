...
<html lang="en">
  <head>
    ...
    <link
      rel="stylesheet"
      href="https://fonts.googleapis.com/css2?family=Alatsi:wght@400&display=swap"
    />
    <?php
      session_start();
   ...
   <header class="site-navbar mt-3">
        ...
        <div class="row align-items-center">
          ...
          <nav class="mx-auto site-navigation col-6">
            <ul class="site-menu js-clone-nav d-none d-xl-block ml-0 pl-0">
              ...
              <li><a></a></li>
              <li class="has-children">
                <a href="entretiens_c.php">Entretiens</a>
                <ul class="dropdown">
    ...
    <section class="section-hero overlay inner-page bg-image" style="background-image: url('../images/hero_1.jpg');" id="home-section">
      <div class="container">
        <div class="row">
          <div class="col-md-7">
            <h1 class="text-white font-weight-bold">Réclamations</h1>
    ...
    <section class="claim-history">
        <div class="claim-history-content">
          <div class="claim-history-header">
            <h2></h2>
          </div>
          <div class="claim-cards">
            <div class="past-requests" id="suivre">
              <div class="past-requests-child"></div>
              <div class="past-requests-card">
                <b class="retrouvez-vos-dernires"
                  >Retrouvez vos dernières demandes</b
                >
                <div class="card-background"></div>
              </div>
              <div class="past-declarations">
                <div class="retrouvez-vos-dernires1">
                  Retrouvez vos dernières déclarations déposées ou
                  l'historique de vos conversations avec l'un de nos
                  conseillers.
                </div>
              </div>
              <div class="track-claims-button">
                <a href="listeReclamation.php" style="text-decoration: none;">
                    <button class="button5">
                        <img
                            class="plus-circle-icon1"
                            alt=""
                            src="./public/pluscircle.svg"
                        />
                        <b class="suivre-mes-reclamations">
            ...
            <img
              class="heytham7367-two-people-explori-icon"
              loading="lazy"
              alt=""
              src="./public/heytham7367-two-people-exploring-on-phone-9285fa4172c24a2fa73f40f46650bef7-1@2x.png"
            />
          </div>
        </div>
      </section>
      <section class="new-claim">
        <div class="new-claim-instructions">
          ...
          <img
            class="new-claim-instructions-child"
            loading="lazy"
            alt=""
