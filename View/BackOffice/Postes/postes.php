        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">  
                    ...
                    <a class="nav-item nav-link active"><i class="fa bi-pen-fill me-2"></i>Postes</a>
                            ...
                            <tbody>
                                ...
                                <?php
                                    ...
                                    if(isset($_GET["cin"])){
                                        ...
                                        echo '} else {';
                                        echo '    window.location.href = "postes.php";';
                                        echo '}';
                                        echo '</script>';
                                    }
                                ?>
                            ...
                            <tbody>
                                ...
                                <?php
                                    ...
                                    if(isset($_GET["cin"])){
                                        echo '<script>';
                                        echo '    var cin = "' . htmlspecialchars($_GET["cin"]) . '";';
                                        echo 'var result = confirm("Do you want to delete the post/comment: "+cin+"?");';
                                        echo 'if (result) {';
                                        echo '    window.location.href = "delete.php?cin=' . $_GET["cin"] . '&confirmed=true";';
                                        echo '} else {';
                                        echo '    window.location.href = "postes.php";';
