    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="reclamations.php" class="nav-item nav-link active"><i
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-secondary navbar-dark sticky-top px-4 py-0">
                ...
                <h4 class="tit">Réclamations Archivées</h4>
            ...
            <div class="container-fluid pt-4 px-4">
                ...
                foreach ($liste as $Reclamation) {
                    ...
                    if ($Reclamation['archiveBackRec'] == '1') {
                        ?>
                        ...
                        <div class="offer">
                            ...
                            <div class="offer-actions">
                                ...
                                echo "<input type='hidden' name='archiveBackRec' value='2'>";
